...
void _mint() {
  test('Burn', () {
    ...
    final deserializeOperation = JettonWalletOperation.deserialize(
      body.beginParse(),
    );
    final operation = JettonWalletOperation.fromJson(
      deserializeOperation.toJson(),
    );
  ...
  test('Mint', () {
    ...
    final deserializeOperation = JettonMinterOperation.deserialize(
      body.beginParse(),
    );
    final operation = JettonMinterOperation.fromJson(
      deserializeOperation.toJson(),
    );
