...
void _frindlyForm() {
  test('friendly form', () {
    ...
    // Bounceable
    expect(
      address.toFriendlyAddress(bounceable: true),
      'EQAs9VlT6S776tq3unJcP5Ogsj-ELLunLXuOb1EKcOQi4wJB',
    );
    expect(
      address.toFriendlyAddress(bounceable: true, testOnly: true),
      'kQAs9VlT6S776tq3unJcP5Ogsj-ELLunLXuOb1EKcOQi47nL',
    );
    expect(
      address.toFriendlyAddress(bounceable: true),
    ...
    expect(
      address.toFriendlyAddress(testOnly: true, bounceable: true),
      'kQAs9VlT6S776tq3unJcP5Ogsj-ELLunLXuOb1EKcOQi47nL',
    );

    // Non-Bounceable
    expect(
      address.toFriendlyAddress(bounceable: false),
      'UQAs9VlT6S776tq3unJcP5Ogsj-ELLunLXuOb1EKcOQi41-E',
    );
    expect(
      address.toFriendlyAddress(bounceable: false, testOnly: true),
      '0QAs9VlT6S776tq3unJcP5Ogsj-ELLunLXuOb1EKcOQi4-QO',
    );
    expect(
      address.toFriendlyAddress(bounceable: false),
