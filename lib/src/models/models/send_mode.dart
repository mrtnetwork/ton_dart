...
class SendMode {
  ...
  static const SendMode carryAllRemainingBalance = SendMode._(
    SendModeConst.carryAllRemainingBalance,
  ...
  static const SendMode destroyAccountIfZero = SendMode._(
    SendModeConst.destroyAccountIfZero,
    'destroyAccountIfZero',
  );

  /// Predefined constant for the mode that pays gas separately.
  static const SendMode payGasSeparately = SendMode._(
    SendModeConst.payGasSeparately,
    'payGasSeparately',
  );

  /// Predefined constant for the mode that ignores errors during transaction.
  static const SendMode ignoreErrors = SendMode._(
    SendModeConst.ignoreErrors,
    'ignoreErrors',
  );
