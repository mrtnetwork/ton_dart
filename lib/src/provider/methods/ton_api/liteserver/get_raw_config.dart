...
class TonApiGetRawConfig
    extends TonApiRequest<RawConfigResponse, Map<String, dynamic>> {
  ...
  @override
  RawConfigResponse onResonse(Map<String, dynamic> result) {
    return RawConfigResponse.fromJson(result);
  }
}
