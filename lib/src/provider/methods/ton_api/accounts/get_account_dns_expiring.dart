...
class TonApiGetAccountDnsExpiring
    extends TonApiRequest<DnsExpiringResponse, Map<String, dynamic>> {
  ...
  @override
  DnsExpiringResponse onResonse(Map<String, dynamic> result) {
    return DnsExpiringResponse.fromJson(result);
  }
}
