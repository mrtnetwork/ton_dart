...
class BlockValueFlowResponse with JsonSerialization {
  ...
  factory BlockValueFlowResponse.fromJson(Map<String, dynamic> json) {
    return BlockValueFlowResponse(
      fromPrevBlk: BlockCurrencyCollectionResponse.fromJson(
        json['from_prev_blk'],
      ),
      ...
      feesCollected: BlockCurrencyCollectionResponse.fromJson(
        json['fees_collected'],
      ),
      burned:
          json['burned'] != null
              ...
              : null,
      feesImported: BlockCurrencyCollectionResponse.fromJson(
        json['fees_imported'],
      ),
