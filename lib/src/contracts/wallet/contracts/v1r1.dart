...
class WalletV1R1 extends WalletContract {
  ...
  const WalletV1R1._({required this.state, required this.address});

  factory WalletV1R1({required int workChain, required List<int> publicKey}) {
  ...
  static Future<WalletV1R1> fromAddress(
    ...
    return WalletV1R1._(state: state.item1, address: address);
  }
